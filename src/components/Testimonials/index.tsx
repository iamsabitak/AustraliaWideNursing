  ...
  return (
    ...
    >
      <div className="container">
        <h1 className="mx-auto text-center text-5xl font-extrabold dark:text-white">
          Latest jobs
        </h1>
        <div className="mt-10 flex justify-center">
          <div className="mt-10 grid justify-center gap-18 md:grid-cols-2 lg:grid-cols-2">
            {jobs.map((job) => (
              <div
                key={job.id}
                className="dark:bg-dark h-110 w-105 cursor-pointer justify-center rounded-2xl bg-white p-10 transition duration-300 hover:bg-gray-300 dark:text-white dark:hover:bg-gray-800"
              >
                ...
                <p className="mb-5 text-sm dark:text-gray-100">{job.date}</p>
